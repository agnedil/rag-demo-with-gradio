...
4. Set up environment variables REPLICATE_API_TOKEN (for an LLM hosted on replicate.com) and COHERE_API_KEY (for embeddings and reranking service on cohere.com)
